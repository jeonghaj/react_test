...
class Post extends Component{
  ...
  componentWillUnmount(){
    console.log("Post 컴포넌트에서 무언가 마무리 작업을 한다")
  }

  //전체 글 목록을 받아오는 함수 
  getPosts = ()=>{
    // axios가 get 방식 "v2/posts" 요청을 대신 해준다
    // 응답되는 json 문자열을 실제 array or object 로 변경해서 then() 함수 안에 전달한 함수의 매개변수 res 에 넣어준다.
    // res 는 object 이고 res 의 data 라는 방에 array or object 가 들어있다.
    axios.get("/v2/posts")
    .then(res=>{
      console.log(res)
      this.setState({
